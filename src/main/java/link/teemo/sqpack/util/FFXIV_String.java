...
public class FFXIV_String
{
  ...
  static final byte[] forenamePayload = { -1, 7, 2, 41, 3, -21, 2, 3, -1, 2, 32, 2, 3 };
  static final byte[] surnamePayload = { -1, 7, 2, 41, 3, -21, 2, 3, -1, 2, 32, 3, 3 };
  ...
  private static void processPacket(ByteBuffer buffIn, ByteBuffer buffOut) throws UnsupportedEncodingException {
    ...
    case 40:
      ...
      break;
    case 64:
      byte[] exdName = new byte[payload[6] - 1];
